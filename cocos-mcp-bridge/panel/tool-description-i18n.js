...
const ZH_TOOL_DESCRIPTIONS = {
  ...
  create_cocos_mcp_project_skill: '为 Cocos MCP Bridge 工作流创建推荐的本地 Codex 项目技能。',
  generate_sprite: '生成一张 2D 游戏精灵（角色/敌人/道具/头像），自动写 Cocos .meta 并落盘，返回 spriteFrame uuid。需 VOLC_ARK_API_KEY。',
  generate_image: '生成任意图片（概念图/场景/宣传图/UI 大图），写 Cocos .meta 落盘。ui_mode=true 走 UI 专用构图。需 VOLC_ARK_API_KEY。',
